...
function createEnemy($container, x, y) {
  const $element = document.createElement("img");
  $element.src = "assets/invader/row-1-col-1.jpg";
...
// function explosion($container, x, y) {
//   const $element = document.createElement("img");
//   $element.src = "assets/explode/";
...
//   const explosion = {x, y, cooldown: rand(0.5, ENEMY_COOLDOWN), $element};
//   GAME_STATE.explosions.push(explosion);
//   setPosition($element, x, y);
// }
...
function createEnemyLaser($container, x, y) {
  const $element = document.createElement("img");
  $element.src = "assets/enemy-bullet.png";
